    ...
    <section className="py-20 sm:py-24 md:py-32 px-4 sm:px-6 md:px-12" id="timeline" aria-label="Engineering journey timeline">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative mt-12 md:mt-16">
          {/* Vertical Line */}
          <div className="absolute left-[12px] md:left-[16px] top-0 bottom-0 w-[1px] bg-gradient-to-b from-transparent via-white/[.07] to-transparent" />

          {timeline.map((entry, i) => (
            <ScrollReveal
              key={entry.year}
              delay={0.1 * i}
              className="relative mb-8 md:mb-12 last:mb-0 pl-[28px] md:pl-[36px] group"
            >
              {/* Dot */}
              <div className="absolute left-[12px] md:left-[16px] top-[28px] md:top-[42px] -translate-x-1/2 z-10">
                <div className="w-2.5 md:w-3 h-2.5 md:h-3 bg-gold rounded-full shadow-[0_0_0_4px_rgba(200,164,74,.13)] transition-all duration-300 group-hover:scale-110 group-hover:shadow-[0_0_0_8px_rgba(200,164,74,.15),0_0_18px_rgba(200,164,74,.4)]" />
              </div>

              {/* Card */}
              <div className="bg-white/[.035] border border-white/[.07] rounded-xl p-5 md:p-8 transition-all duration-400 hover:border-gold/20 hover:translate-x-1.5 relative overflow-hidden before:content-[''] before:absolute before:inset-0 before:bg-gradient-to-br before:from-gold/[.04] before:to-transparent before:opacity-0 before:transition-opacity before:duration-300 hover:before:opacity-100">
